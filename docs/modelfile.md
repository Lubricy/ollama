...
| parallel       | Sets the max parallel requests for generation. Setting this to a number greater than 1 will enable continuous batching mode. (Default: 1)                                                                                       | int        | seed 42              |
